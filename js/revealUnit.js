...
RevealUnit.prototype.showNumber = function(n, fontSize, x, y){
	// console.log(n);
...
RevealUnit.prototype.isWithinNumberText = function(x,y){
	return this.checkWithinRect(x,y,this.rectToCheck);
};
...
RevealUnit.prototype.getPercentageRevealed = function (maskBMD) {
    ...
    if(!this.isRevealed){
        ...
        this.totalPixels = this.rectToCheck.width*this.rectToCheck.height;
        this.rectToCheck.x -= this.boundaryRect.x;
        this.rectToCheck.y -= this.boundaryRect.y;
        this.tempPixelsData = maskBMD.getPixels(this.rectToCheck).data;//+++++++++++
        //this.tempPixelsData.copyRect(maskBMD,this.rectToCheck, 0,0);
        this.rectToCheck.x += this.boundaryRect.x;
        this.rectToCheck.y += this.boundaryRect.y;
